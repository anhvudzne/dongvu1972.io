...
<main class="flex-grow-1 flex-shrink-1">
   ...
   if($_login != null) {
      if($_status == "0") {
   echo '<div class="alert alert-info">Bạn chưa mở khóa thành viên, bạn có thể bấm vào đây <a href="/active"> để kích hoạt tài khoản</a> (Phí: 10,000 VND = 10,000 COIN).</div>';
   }
      if($_status == "1") {
